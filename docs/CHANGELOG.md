...
- Square checkout now charges a configured flat customer shipping fee as a Square order service charge, and payment verification compares Square totals against pending order `total_cents`.
